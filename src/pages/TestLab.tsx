...
const PRESETS = {
  clean: [
    ...
    { donator: 'Salsa', amount: 35000, message: 'Aku suka banget cara kamu jelasin topiknya.' },
    { donator: 'Fajar', amount: 60000, message: 'Ini buat kopi, biar live-nya makin lancar.' },
    { donator: 'Mira', amount: 12000, message: 'Pertama kali mampir, ternyata seru juga.' },
    { donator: 'Tara', amount: 90000, message: 'Terima kasih sudah bikin suasana malam ini nyaman.' },
    { donator: 'Galih', amount: 18000, message: 'Bang coba bahas setup audio yang dipakai dong.' },
    { donator: 'Irene', amount: 55000, message: 'Support kecil buat creator favorit.' },
    { donator: 'Kevin', amount: 42000, message: 'Nice gameplay, clutch terakhir keren banget.' },
    { donator: 'Luna', amount: 70000, message: 'Semoga target bulan ini cepat tercapai.' },
    { donator: 'Mika', amount: 22000, message: 'Thanks udah baca chat aku tadi.' },
    { donator: 'Reno', amount: 85000, message: 'Keep grinding, kualitasnya naik terus.' },
    { donator: 'Sena', amount: 16000, message: 'Buat cemilan pas editing nanti.' },
    { donator: 'Yudha', amount: 110000, message: 'Respect buat konsistensinya.' },
  ],
  judol: [
    ...
    { donator: 'JP_Mania', amount: 6600, message: 'jackpot besar hari ini, depo 20 langsung gas' },
    { donator: 'SitusRaja', amount: 15000, message: 's i t u s paling gacor, menang tiap spin' },
    { donator: 'D3poReceh', amount: 10000, message: 'depo receh bisa wd besar, buruan daftar' },
    { donator: 'PolaMalam', amount: 27000, message: 'pola slot malam ini gampang pecah scatter' },
    { donator: 'SpinCuan', amount: 33000, message: 'spin santai auto cuan, modal kecil hasil gede' },
    { donator: 'AgenVIP', amount: 45000, message: 'agen resmi bonus harian dan freebet member baru' },
    { donator: 'WDCepat', amount: 12000, message: 'wd kilat tanpa ribet, maxwin tiap hari' },
    { donator: 'Gacor88', amount: 8888, message: 'g a c o r 88 slot online terpercaya' },
    { donator: 'RungkadNo', amount: 19000, message: 'anti rungkad bos, rtp tinggi jam sekarang' },
    { donator: 'CasinoTop', amount: 25000, message: 'casino online bonus deposit 50 persen' },
    { donator: 'TogelLive', amount: 11000, message: 'togel live pasaran lengkap angka jitu malam ini' },
    { donator: 'FreebetID', amount: 14000, message: 'claim freebet dulu baru main, pasti profit' },
  ],
  spam: [
    ...
    { donator: 'GiftBox', amount: 1000, message: 'selamat kamu terpilih, ambil hadiah di http://claim-now.test' },
    { donator: 'KreditNow', amount: 2500, message: 'butuh dana? pinjaman online langsung cair tanpa survei' },
    { donator: 'FollowerPlus', amount: 1500, message: 'jasa tambah followers murah garansi permanen dm sekarang' },
    { donator: 'Broadcast', amount: 2000, message: 'promo besar hubungi telegram @adminpromo cepat' },
    { donator: 'VoucherBot', amount: 1000, message: 'kode voucher gratis: KLAIM100 klik link bio' },
    { donator: 'SurveyPay', amount: 3000, message: 'isi survey 1 menit dapat saldo dana' },
    { donator: 'DMFast', amount: 500, message: 'open paid promote semua niche, kontak wa 08xx' },
    { donator: 'CryptoDrop', amount: 4000, message: 'airdrop token gratis connect wallet sekarang' },
    { donator: 'FlashSale', amount: 3500, message: 'diskon 99 persen khusus 10 menit pertama klik sekarang' },
    { donator: 'RandomAds', amount: 1200, message: 'kerja dari hp penghasilan harian daftar via link ini' },
    { donator: 'AutoReply', amount: 800, message: 'halo kak cek dm ya ada penawaran kerja sama cepat' },
    { donator: 'PrizeDay', amount: 1700, message: 'nomor kamu menang hadiah, verifikasi data sekarang' },
  ],
};
